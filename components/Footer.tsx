...
export default function Footer() {
  return (
    <footer className="bg-[var(--bg-secondary)] border-t border-gray-800 py-12">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Principal Software Engineer specializing in enterprise Java architecture and application modernization
            </p>
          </div>
          ...
          <div>
            <h4 className="font-semibold text-lg mb-4 text-gray-200">Connect</h4>
            <div className="space-y-3">
              <a
                href="https://www.linkedin.com/in/shabina-bozai"
                target="_blank"
        ...
        <div className="pt-8 border-t border-gray-800 text-center">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} Shabina Bozai. All rights reserved.
          </p>
